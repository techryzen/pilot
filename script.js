...
class ChatbotPopup {
    constructor() {
        // API Configuration - using config file
        const config = window.CHATBOT_CONFIG || {};
        this.apiKey = config.OPENAI_API_KEY || 'your-openai-api-key-here';
        this.apiUrl = 'https://api.openai.com/v1/chat/completions';
        this.model = config.MODEL || 'gpt-4o-mini';
        this.siteUrl = window.location.origin + window.location.pathname.replace(/\/$/, '');
        this.siteName = 'Captain AI Chatbot';
